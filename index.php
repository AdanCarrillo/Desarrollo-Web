            ...
            <div class="row" data-aos="fade-up">
              <div class="col-md-12 text-center">
                ...
                <ul>
                     ...
                     if(isset($_GET['limite'])){
                       if($_GET['limite']>0){
                         echo '<li><a href="index.php?limite='.($_GET['limite']-5).'">&lt;</a></li>';
                       }
                     }
                       for($k=0;$k<$totalBotones;$k++){
                         echo '<li><a href="index.php?limite='.($k*5).'">'.($k+1).'</a></li>';
                       }
                       if(isset($_GET['limite'])){
                         ...
                         echo ' <li><a href="index.php?limite=5">&gt;</a></li>';
                       }
                      ?>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-1"><a href="#" class="d-flex"><span>Tequila</span>
                <li class="mb-1"><a href="#" class="d-flex"><span>Whisky</span>
                <li class="mb-1"><a href="#" class="d-flex"><span>Ron</span>
              </ul>
            </div>
            </div>        
        </div>        
