<?php
  ...
  if(isset($_SESSION['carrito'])){
   //si existe buscamos si y estaba agregado ese producto
   if(isset($_GET['id'])){
                ...
                ?>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/<?php echo $arregloCarrito[$i]['Imagen']; ?>" alt="Images" class="img-fluid">
                    </td>
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Pasar a caja</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      function incrementar(cantidad,precio,id){
        var mult = parseFloat(cantidad) * parceFloat(precio);
        $(".cant"+id).text("$"+mult);
        $.ajax({
          method:'POST',
